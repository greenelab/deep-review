...
[@N96QKgly] and the Avon Longitudinal Study of
Parents and Children [@1FjSxrV1k] have yielded
...
treatment [@6RHepB1T]. Efforts to model sequences of events have
shown promise [@ogs3PPp7] but require exceedingly large patient
...
predict ADMET traits for lead generation [@uP7SgBVd] and
how drugs are metabolized [@7QsMcDYy].
...
domain [@xPkT1z7D], and the 2012 Merck Molecular Activity
...
fixed-width bit vector fingerprint [@QnZ7V9Rd].  The same
fingerprints have been used by some drug-target interaction methods discussed
above [@oTF8O79C].  An overly simplistic but
...
input.  Duvenaud et al. [@Oe573FaL] generalized standard
...
particular prediction task.   Lusci et al. [@17Wih4Hd5] adapted
...
trained on high-dimensional EHR data [@5x3uMSKi].  A
...
on the output of the network. Zhou and Troyanskaya [@2UI1BZuD]
scored genomic sequences by introducing virtual mutations at each position and
quantifying the change in the output. Ribeiro et al. [@QwXSJhr0]
...
[@voh0OiT2] applied constant-value masks to different input
...
al. [@Kk20paR7] proposed a novel strategy based on
