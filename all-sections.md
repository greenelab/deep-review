...
idea that was first proposed in 1943 [@1HVDhhwpK] as a model for
...
is interesting in its own right [@1G5eCiq4d]. With the gains
...
[@3qm8sXnB]. Dropout of nodes, edges and layers makes networks more
...
recent book from Goodfellow et al [@yg8NW0K7] covers
...
demonstrated success from the game of Go [@2gn6PKkv] to quantum
physics [@BYO1aJEG].
...
be decomposed into sets of 2D images [@11NHbWB1V]. This greatly expands
...
[@15JUKBg9y]. Diet Networks use multiple networks to drastically
...
[@1GhHIDxuW] generalization) can be learned directly from the input data or
...
and DragoNN [@117PEpTMe] exemplify the benefits of sharing code under an open
