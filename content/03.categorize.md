...
Evaluation on four independent datasets demonstrated that NegBio is highly accurate for detecting negative and equivocal findings (~90% in F~1~ score, which balances precision and recall [@doi:10.1038/nmeth.3945]).
