...
Although rich clinical information is stored in EHRs, manually annotating them is not only costly and time consuming but also requires domain knowledge.
...
Alternatively, researchers have investigated how to text-mine annotations from the corresponding narrative portions of the EHR as the silver standard benchmark dataset [@doi:10.3115/1572392.1572411].
