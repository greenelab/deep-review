...
For drug-drug interaction, [@doi:10.1093/bioinformatics/btw486] used a CNN that employs word embeddings with the syntactic information of a sentence as well as features of POS tags and dependency trees.
[@doi:10.18653/v1/w17-2302] experimented with an attention CNN, and [@arxiv:1705.03261] a recurrent neural network model (RNN) model with multiple attention layers.
