...
* encoding models of retina, visual system, auditory system (DiCarlo, Poggio, etc), NeoCognitron, and the original inspiration for CNNs
* encoding++: mind-reading with fMRI using CNNs
* nonlinear dimensionality reduction of neural activity using RNN-VAEs (LFADS Sussillo)
* neural circuit reconstruction, CNNs for connectomics (Seung, Jain, Turaga)

#### Relevant reviews

* Marblestone, A. H., Wayne, G., & Körding, K. P. (2016). Toward an Integration of Deep Learning and Neuroscience. *Frontiers in Computational Neuroscience*, *10*(5), 94. [@doi:10.3389/fncom.2016.00094]
* Kietzmann, T. C., McClure, P., & Kriegeskorte, N. (2017). Deep Neural Networks In Computational Neuroscience. *bioRxiv*, 133504. [@doi:10.1101/133504]
