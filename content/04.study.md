...
Artificial neural networks were originally conceived as a model for computation in the brain. The deep artificial neural networks of today have evolved to become a workhorse in computer science, with broad applications across many fields outside of neuroscience. However, there is still a deep connection between deep networks and the study of the brain. The rich parallel history of deep neural networks and neuroscience is reviewed in [@doi:10.3389/fncom.2016.00094; @doi:10.1101/133504].
...
As with other fields of science, deep networks have also been useful as computational tools in neuroscience. They have been developed as statistical time series models of neural activity in the brain, and for decoding neural activity in brain machine interfaces [@doi:10.1101/152884]. And they have revolutionized the field of connectomics which is concerned with mapping the connectivity of biological neural networks in the brain. In connectomics, deep networks are used to segment the shapes of individual neurons and to infer their connectivity from 3d electron microscopic images [@doi:10.1016/j.conb.2010.07.004], and they have been also been used to infer causal connectivity from optical measurement and perturbation of neural activity [@tag:Aitchison2017].