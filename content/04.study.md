...
There appears to be significant room for improvement since none of the current approaches for cross cell-type prediction explicitly account for the fact that TFs can co-bind with distinct co-factors in different cell states.
