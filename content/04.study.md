...
For instance, a convolutional neural network applied to histone modifications, termed DeepChrome, improved prediction accuracy of high or low gene expression over existing non-neural network
methods [@tag:Singh2016_deepchrome].
Recently DeepChrome is further improved by a follow-up study, AttentiveChrome through a deep attention model [@tag:Singh2017_attentivechrome].
