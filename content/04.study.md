...
* encoding models of retina, visual system, auditory system (DiCarlo, Poggio, etc), NeoCognitron
* encoding++: mind-reading (Berkeley fMRI)
* nonlinear dimensionality reduction, LFADS etc (Sussillo)
* neural circuit reconstruction (Seung, Jain, Turaga)
