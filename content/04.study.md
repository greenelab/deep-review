...
Artificial neural networks were originally conceived as a model for computation in the brain. The deep multi-layer neural networks of today are mathematical and statistical objects in machine learning, with vast practical applications across many fields outside of neuroscience. However, there is still a deep connection between deep learning and the study of the brain. The rich parallel history of deep neural networks and neuroscience is reviewed in [@doi:10.3389/fncom.2016.00094; @doi:10.1101/133504].
