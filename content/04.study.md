...
Neural networks can also visualize [@doi:10.1101/178624] and learn meaningful low dimensional representations of single cell expression data [@doi:10.1093/nar/gkx681; @arxiv:1709.02082].
These latent representations can be used to identify cellular subpopulations or match new cells to known cell types.
