...
What is the correspondence between FDR metrics and commonly used classification metrics such as AUPR (area under the precision-recall curve) and AUROC (area under the receiver-operating-characteristic curve)? AUPR evaluates the average precision, or equivalently, the average FDR across all recall thresholds.
