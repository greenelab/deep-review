...
Epistemic uncertainty describes uncertainty about the model and is caused by insufficient training data or by a difference in the training set and testing set distributions.
This uncertainty vanishes in the limit of infinite data.
On the other hand, aleatoric uncertainty describes uncertainty inherent in the observations and is due to noisy or missing data.
This uncertainty vanishes with the ability to observe all independent variables with infinite precision.
