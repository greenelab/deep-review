...
Meanwhile, there are various methods for modeling epistemic uncertainty, which we outline in what follows.
...
Krueger et al. introduced Bayesian hypernetworks [@tag:bayesian_hypernets] as another framework for approximate Bayesian inference in deep learning.
...
Krueger et al. used an invertible generative network to map isotropic Gaussian noise to parameters of the primary network, which allowed computationally cheap sampling and tractable estimation of the posterior.
