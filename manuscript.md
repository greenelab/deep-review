...
<small><em>
This manuscript
([permalink](https://greenelab.github.io/deep-review/v/f000c4c7a6ff03605235db8f1b3fd6f6ab5b47ad/))
was automatically generated
from [greenelab/deep-review@f000c4c](https://github.com/greenelab/deep-review/tree/f000c4c7a6ff03605235db8f1b3fd6f6ab5b47ad)
on July 23, 2019.
</em></small>
...
DeepSignal employs a convolutional neural network to construct features from raw electrical Nanopore signals from sites near a methylated base, and concatenates uses a bi-directional recurrent neural network on DNA sequences of the aligned signals to detect methylation [@17sl0Ti0w].
DeepCpG applies a similar method using scBS-Seq, DNA sequence and Bidirectional GRUs [@19EJTHByG] and methods like DAPL, MRCNN and DeepMethyl incorporate sequence and topological structure [@WWSBQM3] [@NzYX9e9i] [@gXQfsrAl] [@1AfEMOdlu] [@fUGhxx3W].
In addition to this, Gene expression has been used to infer and impute methylation states [@L0qjpS0U] [@1szm3mxk], methylation of genes predicted from promoter methylation [@GbgdMBjb], and convolutional models have been able to predict methylation status from images [@DSTA8ohX] [@54x3LbFb].
...
For instance, Deep Neural Networks (DNN) have been employed on DNA methylation data to predict triglyceride concentrations pre- and post-treatment [@1GRpO6k1o] [@bnD7Q1cQ] and differentiate cancer subtypes [@GLXmFOus] [@EXGRa0DD] while outperforming other methods such as Support Vector Machine (SVM).
