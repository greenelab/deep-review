...
methylation, or gene expression. Without cell-specific features, we need models
which can handle the differences between the domains. For example, if we have
