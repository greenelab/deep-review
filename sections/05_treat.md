...
@doi:10.1038/nrd4609]. Ever since the concept of the Connectivity Map was
proposed [@doi:10.1126/science.1132939], several advanced computational methods
...
@doi:10.1186/s12859-015-0845-0]. Menden et al
[@doi:10.1371/journal.pone.0061318] used a shallow neural network to predict
...
Drug repositioning can also be approached by attempting to predict novel drug -
target interactions and then repurposing the drug for the associated
...
[@doi:10.1021/acs.jproteome.6b00618] extended this concept to
deep learning by creating a deep belief network of stacked RBMs, DeepDTIs,
predicting interaction on the basis of chemical structure and protein sequence
features.
