...
natural way to represent a chemical structure. 
 Traditional machine learning approaches relied on preprocessing the graph into a feature vector, such as a
...
within this latent space. The strategy of constructing simple, continuous features
